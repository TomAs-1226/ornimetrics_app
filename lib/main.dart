...
class _SettingsScreenState extends State<SettingsScreen> with SingleTickerProviderStateMixin {
  ...
  void _populateDemoData() {
    // Canned demo data + demo mode (no network) lives in the API service so it
    // can be restored on relaunch when the demo feeder is the active device.
    FeederApiService.instance.enableDemo();
  }
}
